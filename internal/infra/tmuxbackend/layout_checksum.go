...
// layoutChecksum computes tmux's 16-bit window-layout checksum over body, the
// layout string without its leading "checksum," prefix. tmux rejects a custom layout

...
type (
	WorktreeMutationKind     = corebackend.WorktreeMutationKind
	MutationRejectedError    = corebackend.MutationRejectedError
	MutationNotIssuedError   = corebackend.MutationNotIssuedError
	WorkspaceObservation     = corebackend.WorkspaceObservation
	WorkspacePaneObservation = corebackend.WorkspacePaneObservation
	OwnedWorktreeRoute       = corebackend.OwnedWorktreeRoute
	WorkspaceCreateRequest   = corebackend.WorkspaceCreateRequest
	WorktreeCreateRequest    = corebackend.WorktreeCreateRequest
	WorktreeOpenRequest      = corebackend.WorktreeOpenRequest
	WorktreeMutationResult   = corebackend.WorktreeMutationResult
)

const (
	WorkspaceCreate = corebackend.WorkspaceCreate
	WorktreeCreate  = corebackend.WorktreeCreate
	WorktreeOpen    = corebackend.WorktreeOpen
)

var (
	ErrMutationRejected  = corebackend.ErrMutationRejected
	ErrMutationNotIssued = corebackend.ErrMutationNotIssued
)

...
10. **On failure**: consult `/Users/butaosuinu/fanout/README.md` Troubleshooting and surface the most likely fix. Common cases:
   ...
   - `agent is required` → rerun with `--agent claude`, `--agent codex`, set `FANOUT_AGENT`, or cover every selected child with `--agent NUM=name`.

...
These three cover the default tmux backend. The opt-in [herdr backend]({{< relref "/docs/herdr-backend" >}}) swaps tmux for stable herdr 0.7.5 or newer on CLI launch lanes. herdr is not bundled with fanout; install it separately.

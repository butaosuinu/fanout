...
import { useDrawnDiff } from "./useDrawnDiff";
import type { DiffReport } from "./useDiffReport";
...
export function DiffOverlay({
  ...
  useDiffOverlayModal(rootRef, { covering, suppressed, onCoveringChange: report.setCovering });

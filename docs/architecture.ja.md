...
| infra | `herdrrun` | herdr stable 0.7.5 以上の read-only capability gate、公式 0.7.5 `darwin/arm64` asset に限定した fanout-owned session lifecycle と owned mutation、snapshot 投影 | H |

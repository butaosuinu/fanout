...
func TestClassifyPath(t *testing.T) {
	tests := []struct {
		...
		{name: "contract docs are M", path: "docs/review-checklist.ja.md", want: ClassM, found: true},
		{name: "docs assets are NONE", path: "docs/assets/review.png", want: ClassNone, found: true},
		{name: "docs mockups are NONE", path: "docs/mockups/dashboard.html", want: ClassNone, found: true},

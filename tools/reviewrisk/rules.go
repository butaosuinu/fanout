...
var prefixRules = []struct {
	...
	// core H.
	{"internal/core/backend/", Rule{ID: "core-backend", Class: ClassH, Source: SourceDocTable, Note: "runtime backend 契約(MutationModel を含む)・親 stickiness・選択の fail-closed 判定"}},
